 ...
 *
 * <p>Equivalent to {@link org.apache.UserLoginTag.web.tags.UserTag}</p>
 */
public class UserLoginTag extends SecureTag {
    static final Logger log = Logger.getLogger("UserLoginTag");
