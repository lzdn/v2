...
public class FtpUtil {
	...
	public static String HOST = "120.78.175.253";
	public static int PORT = 21;
	public static String USERNAME = "ceshi";
	public static String PASSWORD = "Ftp@1234";
	public static String BASEPATH = "/home";
	public static String FILEPATH = "/ftptest/img";

	public static String upload(InputStream input, String prefix) {
